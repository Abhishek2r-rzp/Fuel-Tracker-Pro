        ...
        bikeData.mileageStandard !== "N/A" && (
          <div className="card bg-blue-50 border border-blue-200">
            ...
            <p className="text-blue-800">
              Your {bikeData.make} {bikeData.model} has a manufacturer&apos;s claimed
              mileage of <strong>{bikeData.mileageStandard} km/l</strong>.
              Compare this with your actual mileage on the dashboard to see how
              efficiently you&apos;re riding!
            </p>
          </div>
        )}
    </div>
